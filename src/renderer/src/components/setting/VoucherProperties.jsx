                    ...
                    <div className="flex flex-row p-2 justify-between">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="A5">A5 (5.83 in x 8.27 in)</option>
                            </select>
                        </div>
                    </div>
                    <div className="flex flex-row p-2 justify-between">
                    ...
                    <div className="flex flex-row p-2 justify-between">
                        ...
                        <div className="flex flex-row items-center">
                            <input
                                ...
                                id="custom"
                                className="border border-gray-300 rounded-md p-1 mr-2"
                                checked={settings?.enableCustomVoucher}
                                onChange={(e) => {
                                    ChangeSettings(e.target.checked, 'enableCustomVoucher')
                                }}
                            />
                            <label className="text-md cursor-pointer select-none" htmlFor="custom">
                                {t('Enable')}
                            </label>
                            <button
                                className="bg-white border border-gray-300 rounded-md p-2 ml-3"
