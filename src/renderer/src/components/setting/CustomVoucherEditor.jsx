  ...
  const renderItem = (item, index) => {
    return (
      <div style={{ display: 'flex', justifyContent: 'space-between', marginVertical: 5 }}>
        ...
        {values?.isproductcol && (
          <p style={{ fontSize: parseFloat(itemFontsize), width: nameWidth, fontWeight: 'bold' }}>
            {item.name}
          </p>
        )}
        {values?.isqtycol && (
          <p style={{ fontSize: parseFloat(itemFontsize), width: qtyWidth, textAlign: 'center' }}>
            {item.qty}
          </p>
        )}
        {values?.ispricecol && (
          <p style={{ fontSize: parseFloat(itemFontsize), width: priceWidth, textAlign: 'right' }}>
            {numberWithCommas(item.price)}
          </p>
        )}
        {values?.istotalcol && (
          <p style={{ fontSize: parseFloat(itemFontsize), width: totalWidth, textAlign: 'right' }}>
            ...
            <TransformWrapper>
              <TransformComponent
                ...
                contentStyle={{
                  ...
                  height:
                    settings?.paper == 'A4'
                      ? heightofA4(rootwidth - 200)
                      : heightofA5(rootwidth - 200)
                }}
              >
                <div
                  ref={viewRef}
                ...
                >
                  {values?.logoalign == 'center' ? (
                    ...
                    >
                      ...
                      <p
                        ...
                        onClick={() => {
                          onEdit('shopname', values?.shopname || profiledata.name, 'Shop Name')
                        }}
                      >
                        {values?.shopname}
                      </p>
                      <p
                        onClick={() => {
                          onEdit('email', values?.email || profiledata.email, 'Email')
                        }}
                        className="hover:bg-blue-100 cursor-pointer min-h-[10px] min-w-[100px] border"
                      ...
                      <p
                        onClick={() => {
                          onEdit('phoneno', values?.phoneno || profiledata.phoneno, 'Phone No')
                        }}
                        className="hover:bg-blue-100 cursor-pointer min-h-[10px] min-w-[100px] border"
                        style={{ textAlign: 'center', fontSize: parseInt(shopDetailFontSize) }}
                      >
                      ...
                      <p
                        onClick={() => {
                          onEdit('address', values?.address || profiledata.address, 'Address')
                        }}
                        className="hover:bg-blue-100 cursor-pointer min-h-[10px] min-w-[100px] border"
                        style={{ textAlign: 'center', fontSize: parseInt(shopDetailFontSize) }}
                      >
                      ...
                      <div className="flex flex-row items-center">
                        ...
                        <p
                          ...
                          onClick={() => {
                            onEdit(
                              'shopname',
                              values?.shopname || profiledata.shopname,
                              'Shop Name'
                            )
                          }}
                          style={{
                  ...
                  <div style={{ padding: bodyPadding }}>
                    ...
                    {values?.isdeliverychargesrow == false ||
